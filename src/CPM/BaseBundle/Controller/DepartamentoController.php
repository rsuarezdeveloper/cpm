...
use CPM\BaseBundle\Entity\Departamento;
use CPM\BaseBundle\Form\DepartamentoType;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CPMBaseBundle:Departamento')->findAll();
     ...
     * @Method("POST")
     * @Template("CPMBaseBundle:Departamento:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CPMBaseBundle:Departamento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CPMBaseBundle:Departamento:edit.html.twig")
     */
