...
use CPM\BaseBundle\Entity\Cliente;
use CPM\BaseBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CPMBaseBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("CPMBaseBundle:Cliente:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CPMBaseBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CPMBaseBundle:Cliente:edit.html.twig")
     */
